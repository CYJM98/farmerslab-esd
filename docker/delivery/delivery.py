...
# 1) set dbURL=mysql+mysqlconnector://root@localhost:3306/delivery
# python delivery.py
# pip install -r requirements.txt
# 2) docker build -t ycm98/delivery:1.0.0 .
# View Images: docker images
# Remove Image: docker rmi <image id>
# 3) docker run -p 5004:5004 -e dbURL=mysql+mysqlconnector://is213@host.docker.internal:3306/delivery ycm98/delivery:1.0.0
# 4) docker run -p 5400:5004 -e dbURL=mysql+mysqlconnector://is213@host.docker.internal:3306/delivery ycm98/delivery:1.0.0	
